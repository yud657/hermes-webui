...
**vs. the field** *(landscape is actively shifting — see [HERMES.README.md](HERMES.README.md) for the full breakdown)*:
...
ecosystem. See [HERMES.README.md](HERMES.README.md) for the full side-by-side.
...
- `HERMES.README.md` -- why Hermes, mental model, and detailed comparison to Claude Code / Codex / OpenCode / Cursor
