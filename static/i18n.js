...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    insights_range_7d: '7 days',
    insights_range_30d: '30 days',
    insights_range_90d: '90 days',
    insights_range_365d: '365 days',
    system_health_title: 'System health',
    system_health_sub: 'Current VPS resource usage',
    system_health_loading: 'Loading…',
    system_health_status_partial: 'Partial',
    system_health_status_live: 'Live',
    system_health_status_unavailable: 'Unavailable',
    system_health_foot: 'Live snapshot only; historical resource charts can build on this surface later.',
    llm_wiki_title: 'LLM Wiki',
    llm_wiki_sub: 'Knowledge-base observability',
    llm_wiki_badge_available: 'Available',
    llm_wiki_badge_error: 'Error',
    llm_wiki_badge_empty: 'Empty',
    llm_wiki_badge_unavailable: 'Unavailable',
    llm_wiki_status_ready: 'LLM Wiki is configured and page metadata is visible without exposing wiki content.',
    llm_wiki_status_empty: 'LLM Wiki exists but has no entity, concept, comparison, or query pages yet.',
    llm_wiki_status_error: 'Unable to inspect LLM Wiki status',
    llm_wiki_status_missing: 'No LLM Wiki directory was found. Set WIKI_PATH or skills.config.wiki.path to enable status visibility.',
    llm_wiki_field_enabled: 'Enabled',
    llm_wiki_field_entries: 'Entries',
    llm_wiki_field_pages: 'Pages',
    llm_wiki_field_raw_files: 'raw/ files',
    llm_wiki_field_last_updated: 'Last updated',
    llm_wiki_field_last_writer: 'Last writer',
    llm_wiki_value_yes: 'Yes',
    llm_wiki_value_no: 'No',
    llm_wiki_value_not_available: 'Not available',
    llm_wiki_toggle_available: 'Toggle available from configured Hermes Agent setting.',
    llm_wiki_toggle_unavailable: 'No stable LLM Wiki on/off config flag was detected, so this panel is read-only.',
    llm_wiki_docs_link: 'Docs',
  ...
  zh: {
    ...
    settings_plugins_meta: '查看已安装的 Hermes 插件及其注册的生命周期钩子。此面板为只读。',
    settings_plugins_empty: '当前未看到任何 Hermes 插件。可在 Hermes CLI 或 config 中安装/启用插件后查看。',
    plugins_unnamed: '未命名插件',
    plugins_no_description: '未提供描述信息。',
    plugins_no_hooks: '未注册任何生命周期钩子',
    plugins_registered_hooks: '已注册的钩子',
    plugins_enabled: '已启用',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    sign_out: '退出登录',
    // Providers panel
    providers_tab_title: '大模型供应商',
    providers_section_title: '大模型供应商',
    providers_section_meta: '管理大模型供应商的 API key。更改即刻生效。',
    ...
    providers_oauth_config_yaml_hint: '已通过 config.yaml 配置 token。如需更新，请编辑 config.yaml 中的 providers 段或运行 hermes auth。',
    providers_oauth_not_configured_hint: '尚未认证。请在终端运行 hermes auth 完成此大模型供应商的配置。',
    providers_save: '保存',
    providers_remove: '移除',
    providers_saving: '保存中…',
    providers_removing: '移除中…',
    providers_enter_key: '请输入 API key',
    providers_empty: '未找到可配置的大模型供应商。',
    providers_key_updated: 'API key 已保存',
    providers_key_removed: 'API key 已移除',
    providers_key_placeholder_new: 'sk-...',
    providers_key_placeholder_replace: '输入新密钥以替换…',
    provider_quota_title: '当前大模型供应商配额',
    provider_quota_active_provider: '当前大模型供应商',
    ...
    provider_quota_refresh_title: '立即刷新大模型供应商用量限制',
    provider_quota_refresh_succeeded: '大模型供应商用量已刷新',
    provider_quota_refresh_failed: '大模型供应商用量刷新失败',
    ...
    settings_dropdown_providers: '大模型供应商',
    ...
    insights_range_7d: '7 天',
    insights_range_30d: '30 天',
    insights_range_90d: '90 天',
    insights_range_365d: '365 天',
    system_health_title: '系统健康',
    system_health_sub: '当前 VPS 资源使用情况',
    system_health_loading: '加载中…',
    system_health_status_partial: '部分可用',
    system_health_status_live: '实时',
    system_health_status_unavailable: '不可用',
    system_health_foot: '仅为实时快照；后续可在此基础上增加历史资源图表。',
    llm_wiki_title: 'LLM Wiki',
    llm_wiki_sub: '知识库可观测性',
    llm_wiki_badge_available: '可用',
    llm_wiki_badge_error: '错误',
    llm_wiki_badge_empty: '为空',
    llm_wiki_badge_unavailable: '不可用',
    llm_wiki_status_ready: 'LLM Wiki 已配置，可查看页面元数据，且不会暴露 wiki 内容。',
    llm_wiki_status_empty: 'LLM Wiki 已存在，但尚无 entity、concept、comparison 或 query 页面。',
    llm_wiki_status_error: '无法检查 LLM Wiki 状态',
    llm_wiki_status_missing: '未找到 LLM Wiki 目录。请设置 WIKI_PATH 或 skills.config.wiki.path 以启用状态显示。',
    llm_wiki_field_enabled: '已启用',
    llm_wiki_field_entries: '条目',
    llm_wiki_field_pages: '页面',
    llm_wiki_field_raw_files: 'raw/ 文件',
    llm_wiki_field_last_updated: '上次更新',
    llm_wiki_field_last_writer: '最后写入者',
    llm_wiki_value_yes: '是',
    llm_wiki_value_no: '否',
    llm_wiki_value_not_available: '不可用',
    llm_wiki_toggle_available: '可通过已配置的 Hermes Agent 设置切换。',
    llm_wiki_toggle_unavailable: '未检测到稳定的 LLM Wiki 开关配置，因此此面板为只读。',
    llm_wiki_docs_link: '文档',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    insights_range_90d: '90 天',
    insights_range_365d: '365 天',
    system_health_title: '系統健康',
    system_health_sub: '目前 VPS 資源使用情況',
    system_health_loading: '載入中…',
    system_health_status_partial: '部分可用',
    system_health_status_live: '即時',
    system_health_status_unavailable: '不可用',
    system_health_foot: '僅為即時快照；後續可在此基礎上增加歷史資源圖表。',
    llm_wiki_title: 'LLM Wiki',
    llm_wiki_sub: '知識庫可觀測性',
    llm_wiki_badge_available: '可用',
    llm_wiki_badge_error: '錯誤',
    llm_wiki_badge_empty: '空白',
    llm_wiki_badge_unavailable: '不可用',
    llm_wiki_status_ready: 'LLM Wiki 已設定，可檢視頁面中繼資料，且不會暴露 wiki 內容。',
    llm_wiki_status_empty: 'LLM Wiki 已存在，但尚無 entity、concept、comparison 或 query 頁面。',
    llm_wiki_status_error: '無法檢查 LLM Wiki 狀態',
    llm_wiki_status_missing: '找不到 LLM Wiki 目錄。請設定 WIKI_PATH 或 skills.config.wiki.path 以啟用狀態顯示。',
    llm_wiki_field_enabled: '已啟用',
    llm_wiki_field_entries: '項目',
    llm_wiki_field_pages: '頁面',
    llm_wiki_field_raw_files: 'raw/ 檔案',
    llm_wiki_field_last_updated: '上次更新',
    llm_wiki_field_last_writer: '最後寫入者',
    llm_wiki_value_yes: '是',
    llm_wiki_value_no: '否',
    llm_wiki_value_not_available: '不可用',
    llm_wiki_toggle_available: '可透過已設定的 Hermes Agent 設定切換。',
    llm_wiki_toggle_unavailable: '未偵測到穩定的 LLM Wiki 開關設定，因此此面板為唯讀。',
    llm_wiki_docs_link: '文件',
    insights_input_tokens: 'Input',  // TODO: translate
    insights_messages: 'Messages',  // TODO: translate
    insights_models: 'Models',  // TODO: translate
    insights_no_cost: 'N/A',  // TODO: translate
 ...
 */
function loadLocale() {
  setLocale(resolveLocale(localStorage.getItem('hermes-lang')) || 'zh');
}
